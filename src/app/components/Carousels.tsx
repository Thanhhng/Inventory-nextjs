            ...
            <AnimatePresence initial={true} custom={direction}>
              <div
                ...
                <div className='w-full h-full sm:h-fit sm:w-fit relative'>
                  <motion.img custom={direction} key={currentPic} variants={variants} initial="initial" animate="animate" exit="exit" src={data[currentPic]?.image} height={200} width={200} alt='picture'  className='w-[30rem] h-[20rem] object-fill sm:w-[30rem] sm:h-[20rem] rounded-md'></motion.img>
