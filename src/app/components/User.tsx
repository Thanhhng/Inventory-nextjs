...
function UserCard(){
  return (
    <div className='my-6  w-fit pb-8  hover:bg-[#303030] bg-[#242424] rounded-2xl shadow-2xl'>
...
function User() {
  return (
    <div className='flex flex-col sm:flex-row gap-4 sm:justify-around items-center justify-center'>
      <button className='text-gray-300 hover:bg-[white] hover:text-black border-[1px] w-full sm:w-fit border-solid rounded-md shadow-2xl '>
